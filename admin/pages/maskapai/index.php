...
<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="../rute/index.php"><i class="fa fa-map"></i> <span>Rute</span></a></li>
      <li class="active"><a href="index.php"><i class="fa fa-plane"></i> <span>Maskapai</span></a></li>
      <li class="treeview">
        <a href="#">
      ...
      <div class="col-md-6">
        ...
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">Tambah daftar maskapai</h3>
          </div>
          <div class="box-body">
        ...
        <div class="box box-info">
          ...
          <div class="box-body no-padding">
            <table class="table table-striped">
              ...
              <?php
              $query=mysql_query("SELECT * FROM transport ORDER BY id");
              $no=1;
              while($var=mysql_fetch_array($query)){
                ...
                <td><a href='formeditbarang.php?id=$var[id]'>Edit</a></td>
                </tr>";
                $no++;
              }
              echo "</table>";
