						...
						<form action="edit.php" method="POST">
							...
							while($row=mysql_fetch_array($query)){
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" name="dari" placeholder="kota keberangkatan" value="<?php echo $row['dari'];?>">
								</div>
								<div class="form-group">
									<label>tujuan:</label>
									<input type="text" class="form-control" name="tujuan" placeholder="kota tujuan" value="<?php echo $row['tujuan'];?>">
								</div>
								<div class="form-group">
									<label>harga:</label>
